...
class MarRecur:
    ...
    def get_CDF_on_grid_single_perm(self,grid_size, cdf_traindata_oneperm, current_rho, observed_data, extrap_tail = .1, init_dist = 'Cauchy', a = 1.):
        '''
    ...
    def eval_PDFandCDF_on_test_single_perm(self,test_data, cdf_traindata_oneperm, current_rho, init_dist = 'Cauchy', a = 1.):
        '''
    ...
    def pdf_cdf_single_dim(self, observations_oneperm, rho, init_dist='Normal', a=1.):
        ...
        if init_dist == 'Normal':
            ...
            pdf = torch.distributions.cauchy.Cauchy(loc=0.0, scale=1.0).log_prob(observations_oneperm).exp().reshape(num_data)
        elif init_dist == 'Lomax':
